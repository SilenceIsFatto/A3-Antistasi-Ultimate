		class handgunsJCA 
		{
			...
			ITEM(JCA_hgun_P320_black_F, 120, PISTOL_STOCK); //Slightly Lower Accuracy
			ITEM(JCA_hgun_P320_olive_F, 120, PISTOL_STOCK);
			ITEM(JCA_hgun_P320_sand_F, 120, PISTOL_STOCK);
		};
		...
		class sniperRiflesJCA 
		{
			...
			ITEM(JCA_arifle_SR25_black_F, 1700, RIFLE_STOCK);
			ITEM(JCA_arifle_SR25_olive_F, 1700, RIFLE_STOCK);
			ITEM(JCA_arifle_SR25_sand_F, 1700, RIFLE_STOCK);
			
			ITEM(JCA_arifle_SR10_AFG_black_F, 1750, RIFLE_STOCK); //Same thing as the M4A4s
			ITEM(JCA_arifle_SR10_AFG_olive_F, 1750, RIFLE_STOCK);
			ITEM(JCA_arifle_SR10_AFG_sand_F, 1750, RIFLE_STOCK);
			
			ITEM(JCA_arifle_SR10_VFG_black_F, 1750, RIFLE_STOCK);
			ITEM(JCA_arifle_SR10_VFG_olive_F, 1750, RIFLE_STOCK);
			ITEM(JCA_arifle_SR10_VFG_sand_F, 1750, RIFLE_STOCK);

			ITEM(JCA_srifle_AWM_black_F, 1600, 15);
			ITEM(JCA_srifle_AWM_olive_F, 1600, 15);
			ITEM(JCA_srifle_AWM_sand_F, 1600, 15);
		};

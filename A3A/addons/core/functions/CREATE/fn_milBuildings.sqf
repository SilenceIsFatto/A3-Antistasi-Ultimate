...
private _fnc_spawnStatic = {
    ...
    if (["statics"] call A3U_fnc_isSabotaged) exitWith {["A static was going to be spawned, but was sabotaged. Aborting", _fnc_scriptName] call A3U_fnc_log; objNull};
...
private _fnc_spawnStaticUnit = {
    ...
    if (["statics"] call A3U_fnc_isSabotaged) exitWith {["A static (+unit) was going to be spawned, but was sabotaged. Aborting", _fnc_scriptName] call A3U_fnc_log; objNull};
...
for "_i" from 0 to (count _buildings) - 1 do
{
    ...
    call {
        ...
        private _vanillaTowers = ["Land_Cargo_Tower_V1_F", "Land_Cargo_Tower_V1_No1_F", "Land_Cargo_Tower_V1_No2_F", "Land_Cargo_Tower_V1_No3_F", "Land_Cargo_Tower_V1_No4_F", "Land_Cargo_Tower_V1_No5_F", "Land_Cargo_Tower_V1_No6_F", "Land_Cargo_Tower_V1_No7_F", "Land_Cargo_Tower_V2_F", "Land_Cargo_Tower_V3_F", "Land_Cargo_Tower_V4_F"];
        if (_typeB in _vanillaTowers) exitWith // just the big towers which have 3 .50 cals on top
        {
            private _type = selectRandom (_faction get "staticMGs");
